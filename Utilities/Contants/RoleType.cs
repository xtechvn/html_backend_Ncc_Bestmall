namespace Utilities.Contants
{
    public enum RoleType
    {
        ...
        KT = 12,//Kế toán
        DHVe = 13,//Điều hành vé
        Marketing = 14,//Phụ trách mảng tin tức
        DHTour = 15,//Điều hành tour
        DHKS = 16,//Điều hành khách sạn
        TPDHTour = 17,//Trưởng phòng điều hành Tour
        TPDHKS = 18,//Trưởng phòng điều hành khách sạn
        TPDHVe = 19,//Trưởng phòng điều hành vé máy bay
        PhoPTour = 20,//Phó phòng tour
